...
A background service that ingests data from various sources (messengers, mail, calendar) and extracts traits using NLP
to create enriched events for task processing.
...
This is an API-less service that runs as a continuous background process, consuming messages from datasources and
